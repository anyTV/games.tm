            ...
            switch ( scope.tt_placement ) {
              ...
              case 'bottom':
                ttPosition = {
                  ...
                  left: position.left + position.width / 2 - ttWidth / 2 +19
                };
                break;
              case 'left':
                ttPosition = {
...
angular.module("template/datepicker/popup.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/datepicker/popup.html",
    "<ul class=\"dropdown-menu dpicker\" ng-style=\"{display: (isOpen && 'block') || 'none', top: position.top+'px', left: position.left+'px'}\" class=\"dropdown-menu\">\n" +
    "   <li ng-transclude></li>\n" +
    "   <li class=\"divider\"></li>\n" +
...
angular.module("template/typeahead/typeahead-popup.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/typeahead/typeahead-popup.html",
    ...
    // "<span ng-class='{true:\'glyphicon glyphicon-pause yellow\',false:\'green\'}[$index.realstate==\'paused\']'><span ng-show='$index.realstate!=\'paused\''>$</span></span></span>&nbsp;" +
...
angular.module("template/typeahead/typeahead.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/typeahead/typeahead.html",
    ...
    "    <li class='search-type'  ng-repeat=\"match in matches\" ng-class=\"{active: isActive($index) }\" ng-mouseenter=\"selectActive($index)\">\n" +
    // "<span ng-class='{true:\'glyphicon glyphicon-pause yellow\',false:\'green\'}[$index.realstate==\'paused\']'><span ng-show='$index.realstate!=\'paused\''>$</span></span></span>&nbsp;" +
